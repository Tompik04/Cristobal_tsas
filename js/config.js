...
const COLORES = ["Negro", "Blanco", "Gris", "Beige", "Azul", "Marrón", "Celeste", "Kaki", "Verde", "Rojo", "Bordó", "Amarillo", "Rosa", "Naranja", "Violeta", "Mostaza"];

// Talles según categoría (provisorio, se ajusta más adelante)
const TALLES_LETRA = ["S", "M", "L", "XL", "XXL", "3XL", "50", "52", "54"];
const TALLES_NUMERO = ["36", "38", "40", "42", "44", "46", "48", "50", "52"];
